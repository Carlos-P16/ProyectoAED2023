...
# back matter
keywords: |
  Contaminación, Valencia, datos, análisis
abbreviations:
  - short: MDPI
...
```{r mapa_calor, fig.width=6, fig.height=4, fig.align='left', fig.cap="\\label{fig:mapa_calor}"}
...
```{r estaciones_activas, fig.width=6, fig.height=4, fig.align='left', fig.cap="\\label{fig:estaciones_activas}"}
datos %>%
...
Comenzamos con un summary de las variables numéricas de interés para analizar las magnitudes de las variables y como se distribuyen los datos.
...
```{r boxplot_est1, fig.width=5.5, fig.height=4, fig.align='left', fig.cap="\\label{fig:boxplot_est1}"}
# Gases
datos_no_outliers %>%
...
```{r boxplot_est2, fig.width=5.5, fig.height=4, fig.align='left', fig.cap="\\label{fig:boxplot_est2}"}
...
```{r boxplot_anos1, fig.width=5.5, fig.height=4, fig.align='left', fig.cap="\\label{fig:boxplot_anos1}"}
# Gases
datos_no_outliers %>%
...
```{r boxplot_anos2, fig.width=5.5, fig.height=4, fig.align='left', fig.cap="\\label{fig:boxplot_anos2}"}
# Gases
datos_no_outliers %>%
...
Podemos observar un incremento visibleen la medición del ruido medio a lo largo de los años. Obviamente, en los datos del 2020 podemos observar un decrecimiento de los mismos, producto del parón de la pandemia, pero vemos cómo continúa aun así subiendo.
